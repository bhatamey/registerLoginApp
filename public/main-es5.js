...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _guards_auth_guards__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./guards/auth.guards */
    ...
    var appRoutes = [{
      ...
      canActivate: [_guards_auth_guards__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]]
    }, {
      path: 'profile',
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_11__["RouterModule"].forRoot(appRoutes), _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_15__["FlashMessagesModule"].forRoot(), _angular_common_http__WEBPACK_IMPORTED_MODULE_16__["HttpClientModule"], _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_18__["JwtModule"].forRoot({
        config: {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function onRegisterSubmit() {
          ...
          if (!this.validateService.validateRegister(user)) {
            this.flashMessage.show('Form not validated', {
              cssClass: 'alert-danger',
              timeout: 3000
            });
            return false;
          ...
          if (!this.validateService.validateEmail(user.email)) {
            this.flashMessage.show('Email not validated', {
              cssClass: 'alert-danger',
              timeout: 3000
            });
            return false;
          ...
          this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
              _this3.flashMessage.show('Your now registered and can login', {
                cssClass: 'alert-success',
                timeout: 3000
              });
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @auth0/angular-jwt */
    "./node_modules/@auth0/angular-jwt/fesm2015/auth0-angular-jwt.js"); //import { tokenNotExpired } from 'angular2-jwt';


    var AuthService = /*#__PURE__*/function () {
      function AuthService(http, decoder) {
      ...
      _createClass(AuthService, [{
        ...
        value: function loggedIn() {
          var token = localStorage.getItem('id_token');
          var isTokenExpired = this.decoder.isTokenExpired(token); //tokenNotExpired('id_token');
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\Working directory\register-login-mean\angular-src\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
