...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("  <nav class=\"navbar navbar-expand-md navbar-dark bg-dark mb-4\">\n    <a class=\"navbar-brand\" href=\"#\">MEAN APP</a>\n    <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarCollapse\" aria-controls=\"navbarCollapse\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n      <span class=\"navbar-toggler-icon\"></span>\n    </button>\n    <div class=\"collapse navbar-collapse\" id=\"navbarCollapse\">\n      <ul class=\"navbar-nav mr-auto\">\n        <li routerLinkActive='active' ><a routerLink='/' class=\"nav-link\">Home</a></li>\n\n        <li *ngIf=\"!authService.loggedIn()\" routerLinkActive='active' ><a routerLink='/dashboard' class=\"nav-link\">Dashboard</a></li>\n        <li *ngIf=\"!authService.loggedIn()\" routerLinkActive='active' ><a routerLink='/profile' class=\"nav-link\">Profile</a></li>\n\n        <li *ngIf=\"authService.loggedIn()\" routerLinkActive='active' ><a routerLink='/login' class=\"nav-link\">Login</a></li>\n        <li *ngIf=\"authService.loggedIn()\" routerLinkActive='active' ><a routerLink='/register' class=\"nav-link\">Register</a></li>\n        \n        \n        <li *ngIf=\"!authService.loggedIn()\"><a href=\"#\" (click)=\"onLogoutClick()\" class=\"nav-link\">Logout</a></li>\n      </ul>\n    </div>\n  </nav>\n");
...
/* harmony import */ var _guards_auth_guards__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./guards/auth.guards */ "./src/app/guards/auth.guards.ts");
...
const appRoutes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_9__["DashboardComponent"], canActivate: [_guards_auth_guards__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_10__["ProfileComponent"], canActivate: [_guards_auth_guards__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] }
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_13__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_14__["AuthService"], _guards_auth_guards__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]],
...
let RegisterComponent = class RegisterComponent {
    ...
    onRegisterSubmit() {
        ...
        if (!this.validateService.validateRegister(user)) {
            this.flashMessage.show('Form not validated', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        if (!this.validateService.validateEmail(user.email)) {
            this.flashMessage.show('Email not validated', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        this.authService.registerUser(user)
            .subscribe(data => {
            if (data.success) {
                this.flashMessage.show('Your now registered and can login', { cssClass: 'alert-success', timeout: 3000 });
                this.router.navigate(['/login']);
            }
            else {
...
let AuthService = class AuthService {
    ...
    loggedIn() {
        const token = localStorage.getItem('id_token');
        const isTokenExpired = this.decoder.isTokenExpired(token); //tokenNotExpired('id_token');
...
module.exports = __webpack_require__(/*! E:\Working directory\register-login-mean\angular-src\src\main.ts */"./src/main.ts");
